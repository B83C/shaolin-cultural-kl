...
import MenuPopover from "../../MenuPopover"; // plasmic-import: 6nDgJlldVNWD/component
import MenuItem from "../../MenuItem"; // plasmic-import: bVYkXxVIowpk/component
import MenuSection from "../../MenuSection"; // plasmic-import: 4wrGyp3hSBAg/component
...
import * as sty from "./PlasmicSelect.module.css"; // plasmic-import: W5ixpbmHRhiq/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__gozxX)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
