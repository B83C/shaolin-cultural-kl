...
import * as sty from "./PlasmicOverlayArrow.module.css"; // plasmic-import: V4BmUu5oMdN6/css

import TriangleFilledIcon from "./icons/PlasmicIcon__TriangleFilled"; // plasmic-import: H-xjuZo43g7Q/icon
