...
import Label from "../../Label"; // plasmic-import: s_jfRlflBD5c/component
import TextInput from "../../TextInput"; // plasmic-import: 8QvqPvQGiFau/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: eVjJwOqD3OHk/component
import Description from "../../Description"; // plasmic-import: lxb2JB8waTJh/component
...
import * as sty from "./PlasmicTextField.module.css"; // plasmic-import: TI4Ca4cGuqqn/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__sZdmw, {
          [sty.freeBoxiconEnd__sZdmwFdHf9]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__sZdmwQwMsC]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__sZdmwipY2P]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__y2N1W, {
            [sty.freeBoxiconStart__y2N1WQwMsC]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__y2N1WipY2P]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__xx8Sg)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__bsXze, {
            [sty.freeBoxiconEnd__bsXzeFdHf9]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__bsXzeQwMsC]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__bce89)}
                role={"img"}
              />
            ),
