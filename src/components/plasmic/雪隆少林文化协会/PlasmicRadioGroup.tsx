...
import Radio from "../../Radio"; // plasmic-import: 4SWOYO_u44Xp/component
...
import * as sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: rzOqY2ic1zMo/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__sUjtT)}>
            <Radio
              className={classNames("__wab_instance", sty.radio___3EqOg)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__d1E3N)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__ofnPm)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
