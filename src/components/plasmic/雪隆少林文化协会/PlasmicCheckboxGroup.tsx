...
import Checkbox from "../../Checkbox"; // plasmic-import: OK4aR2kS5Z_8/component
...
import * as sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: 9UyiOBlMF1HF/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__pNuim)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__kAcFo)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__jhLoo)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__dekPk)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
