...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: V4BmUu5oMdN6/component
...
import * as sty from "./PlasmicPopover.module.css"; // plasmic-import: ZWGRc7qQy5pr/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__oPhxe)}>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button___3VHu5)}
            label={"Open Popover"}
          />
        ),
