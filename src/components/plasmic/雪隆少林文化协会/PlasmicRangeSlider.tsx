...
import SliderThumb from "../../SliderThumb"; // plasmic-import: zAYyfGzjUl0Y/component
...
import * as sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: sgcdqMp3pKCm/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__pd40F)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__jjNpe)}>
        <div
