...
import * as sty from "./PlasmicMenuItem.module.css"; // plasmic-import: bVYkXxVIowpk/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__s9Hv4)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__atrxi)}>
            <div
              className={classNames(
                projectcss.all,
