...
import * as sty from "./PlasmicRadio.module.css"; // plasmic-import: 4SWOYO_u44Xp/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__tsS2Z)}>
        <div className={classNames(projectcss.all, sty.freeBox__z0U)} />
      </div>
      {renderPlasmicSlot({
