...
import * as sty from "./PlasmicDrawer.module.css"; // plasmic-import: BYcaB9LnScF7/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_q9_SknDuyC1x"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__p0KqA)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__rbStL)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__pKwv)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__ePlj1)}
                    >
                      <Button
                        color={"muted"}
                        label={"Close"}
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__nyRbf)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
