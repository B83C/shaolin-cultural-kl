...
import * as sty from "./PlasmicSlider.module.css"; // plasmic-import: _ybh3jHZFCVR/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames(projectcss.all, sty.freeBox__krVz1)}>
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__cRqw)}>
        <div
