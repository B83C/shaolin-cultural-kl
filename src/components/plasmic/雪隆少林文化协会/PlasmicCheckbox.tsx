...
import * as sty from "./PlasmicCheckbox.module.css"; // plasmic-import: OK4aR2kS5Z_8/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: LulJpE90dZwn/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: -5vvds3fX8to/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__jhWn7)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__nmAo)}
            role={"img"}
          />
        ) : null}
      </div>
