...
import * as sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: 6nDgJlldVNWD/css
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  ...
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__muAv)}
                    label={"Item 2"}
                    value={"item2"}
                  />
